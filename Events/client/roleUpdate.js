...
module.exports = {
    ...
    async execute(client, oldRole, newRole) {
        ...
        if (newRole.name !== oldRole.name) {
            client.guilds.cache.get(newRole.guild.id).channels.cache.get(logChannel).send({
                embeds: [
                    new MessageEmbed()
                        .setColor('#da8d2a')
                    ...
                    new MessageEmbed()
                        ...
                        .addFields(
                            ...
                            { name: '🏷️ ID', value: `\`${newRole.id}\`` },
                            {
                                ...
                                value: `#${parseInt(oldRole.color).toString(16).toUpperCase()}`,
                                inline: true
                            },
                            {
                                name: '🎨 Nouvelle couleur',
                                value: `#${parseInt(newRole.color).toString(16).toUpperCase()}`,
                                inline: true
                            },
