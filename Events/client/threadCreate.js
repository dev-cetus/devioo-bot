...
module.exports = {
    ...
    execute(client, thread) {
        ...
        client.guilds.cache.get(thread.guildId).channels.cache.get(logChannel).send({embeds: [
            new MessageEmbed()
                .setColor('#61d261')
                ...
                .addFields(
                    ...
                    {name: '🔗 Lien', value: `[Lien du thread](https://discordapp.com/channels/${thread.guildId}/${thread.parentId}/${thread.id})`}
                )
                .setTimestamp()
